...
const grate_opponent_1 = __importDefault(require("./bots/grate_opponent"));
dotenv_1.default.config();
const app = (0, express_1.default)();
app.use(body_parser_1.default.json());
app.use((0, cors_1.default)());
const ALL_BOTS = [new random_1.default(), new highcard_1.default(), new grate_opponent_1.default()];
